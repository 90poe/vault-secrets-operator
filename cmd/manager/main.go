...
import (
	...
	"github.com/90poe/vault-secrets-operator/pkg/apis"
	"github.com/90poe/vault-secrets-operator/pkg/controller"
...
func printVersion() {
	log.Info(fmt.Sprintf("Operator Version: %s (build time %s, git SHA %s)",
